...
exports.handler = async function(event) {
    ...
    try {
        ...
        return {
            ...
            // We create a structure similar to Gemini's for minimal frontend changes
            body: JSON.stringify({
                candidates: [{
                    content: {
